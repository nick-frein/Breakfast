...
class chair {
    constructor (gl) {
        ...
        this.chairback = new Ring(gl, 1, 0.5, 0.1, 6, 10, vec3.fromValues(0.7, 0.4, 0.2),
            vec3.fromValues(0.7, 0.4, 0.2));
        this.chairCorner = new UniSphere(gl, 0.5, 6, vec3.fromValues(0xa0/0xf0,0x57/0xff,0x2d/0xff),
            vec3.fromValues(0xa0/0xf0,0x57/0xff,0x2d/0xff));


        this.leg1Transform= mat4.create();
        let moveLeg1 = vec3.fromValues (.25, -2, -1.5);
        let scaleLeg1 = vec3.fromValues (.075, .075, 2);
        ...
        let scaleLeg2 = vec3.fromValues (.075, .075, 2);
        ...
        let moveBack = vec3.fromValues (0.75, 0.20, 2.9);
