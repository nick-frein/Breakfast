...
class food {
    constructor (gl) {
        ...
        this.tartPlateBottom = new Cylinder(gl, .75,.75,.1,16, vec3.fromValues(0xfd/0xff,0xf5/0xff,0xe6/0xff),vec3.fromValues(0xcd/0xff,0xc5/0xff,0xb6/0xff));
        this.tartPlate = new Ring(gl, .75, 1,.05,16,1, vec3.fromValues(0xfd/0xff,0xf5/0xff,0xe6/0xff),vec3.fromValues(0xcd/0xff,0xc5/0xff,0xb6/0xff));
